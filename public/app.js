...
module.exports = function pictureCard(pic) {
  ...
  function render(picture) {
    return yo(_templateObject, picture.liked ? 'liked' : '', pic.url, pic.user.username, pic.user.avatar, pic.user.username, moment(picture.createdAt).fromNow(), like.bind(null, true), like.bind(null, false), pic.likes);
  }
