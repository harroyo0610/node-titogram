...
},{"./homepage":18,"./signin":24,"./signup":26,"page":12}],21:[function(require,module,exports){
'use strict';
...
module.exports = function pictureCard(pic) {
  ...
  function render(picture) {
    return yo(_templateObject, picture.liked ? 'liked' : '', pic.url, pic.user.username, pic.user.avatar, pic.user.username, like.bind(null, true), like.bind(null, false), pic.likes);
  }
...
},{"./template":27,"empty-element":3,"page":12,"title":15}],27:[function(require,module,exports){
'use strict';

var _templateObject = _taggedTemplateLiteral(['<div class="col s12 m7">\n  <div class="row">\n    <div class="signup-box">\n      <h1 class="titogram">Titogram</h1>\n      <form class="signup-form">\n        <h2>Reg\xEDstrate para ver fotos de tus amigos estudiando en Platzi</h2>\n        <div class="section">\n          <a class="btn btn-fb hide-on-small-only">Iniciar sesi\xF3n con Facebook</a>\n          <a class="btn btn-fb hide-on-med-and-up"><i class="fa fa-facebook-official" aria-hidden="true"></i>Iniciar sesi\xF3n</a>\n        </div>\n        <div class="divider"></div>\n        <div class="section">\n          <input type="email" name="email" placeholder="Correo elect\xF3nico"/>\n          <input type="text" name="name" placeholder="Nombre completo"/>\n          <input type="text" name="username" placeholder="Nombre de usuario"/>\n          <input type="password" name="password" placeholder="Contrase\xF1a"/>\n          <button class="btn waves-effect waves-light btn-signup" type="submit">Registrarte</button>\n        </div>\n      </form>\n    </div>\n  </div>\n  <div class="row">\n    <div class="login-box">\n      \xBFTienes una cuenta? <a href="/signin">Entrar</a>\n    </div>\n  </div>\n</div>'], ['<div class="col s12 m7">\n  <div class="row">\n    <div class="signup-box">\n      <h1 class="titogram">Titogram</h1>\n      <form class="signup-form">\n        <h2>Reg\xEDstrate para ver fotos de tus amigos estudiando en Platzi</h2>\n        <div class="section">\n          <a class="btn btn-fb hide-on-small-only">Iniciar sesi\xF3n con Facebook</a>\n          <a class="btn btn-fb hide-on-med-and-up"><i class="fa fa-facebook-official" aria-hidden="true"></i>Iniciar sesi\xF3n</a>\n        </div>\n        <div class="divider"></div>\n        <div class="section">\n          <input type="email" name="email" placeholder="Correo elect\xF3nico"/>\n          <input type="text" name="name" placeholder="Nombre completo"/>\n          <input type="text" name="username" placeholder="Nombre de usuario"/>\n          <input type="password" name="password" placeholder="Contrase\xF1a"/>\n          <button class="btn waves-effect waves-light btn-signup" type="submit">Registrarte</button>\n        </div>\n      </form>\n    </div>\n  </div>\n  <div class="row">\n    <div class="login-box">\n      \xBFTienes una cuenta? <a href="/signin">Entrar</a>\n    </div>\n  </div>\n</div>']);
